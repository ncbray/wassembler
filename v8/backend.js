define(["astutil", "compilerutil", "wasm/ast", "wasm/opinfo"], function(astutil, compilerutil, wast, opinfo) {
  ...
  var ops = {
    ...
    i32fromf32: {bytecode: 0x9d},
    i32fromf64: {bytecode: 0x9e},

    i32fromi64: {bytecode: 0xa1},

    i64fromf32: {bytecode: 0xa2},
    i64fromf64: {bytecode: 0xa3},

    i64fromi32: {bytecode: 0xa6},


    f32fromi32: {bytecode: 0xa8},
    f32fromu32: {bytecode: 0xa9},
    f32fromi64: {bytecode: 0xaa},
    f32fromu64: {bytecode: 0xab},
    f32fromf64: {bytecode: 0xac},

    f64fromi32: {bytecode: 0xae},
    f64fromu32: {bytecode: 0xaf},
    f64fromi64: {bytecode: 0xb0},
    f64fromu64: {bytecode: 0xb1},
    f64fromf32: {bytecode: 0xb2},
  };

  var unaryOpEncodingTable = [
    {optype: "i32", op: "boolnot", bytecode: 0x5a},
    {optype: "f32", op: "neg", bytecode: 0x7c},
    {optype: "f32", op: "sqrt", bytecode: 0x82},
    {optype: "f64", op: "neg", bytecode: 0x90},
    {optype: "f64", op: "sqrt", bytecode: 0x96},
  ];
  ...
  var binaryOpEncodingTable = [
    ...
    {optype: "i32", op: opinfo.binaryOps.ne, bytecode: 0x4e},
    {optype: "i32", op: opinfo.binaryOps.slt, bytecode: 0x4f},
    {optype: "i32", op: opinfo.binaryOps.sle, bytecode: 0x50},
    {optype: "i32", op: opinfo.binaryOps.ult, bytecode: 0x51},
    {optype: "i32", op: opinfo.binaryOps.ule, bytecode: 0x52},
    {optype: "i32", op: opinfo.binaryOps.sgt, bytecode: 0x53},
    {optype: "i32", op: opinfo.binaryOps.sge, bytecode: 0x54},
    {optype: "i32", op: opinfo.binaryOps.ugt, bytecode: 0x55},
    {optype: "i32", op: opinfo.binaryOps.uge, bytecode: 0x56},

    {optype: "i64", op: opinfo.binaryOps.add, bytecode: 0x5b},
    {optype: "i64", op: opinfo.binaryOps.sub, bytecode: 0x5c},
    {optype: "i64", op: opinfo.binaryOps.mul, bytecode: 0x5d},
    {optype: "i64", op: opinfo.binaryOps.sdiv, bytecode: 0x5e},
    {optype: "i64", op: opinfo.binaryOps.udiv, bytecode: 0x5f},
    {optype: "i64", op: opinfo.binaryOps.srem, bytecode: 0x60},
    {optype: "i64", op: opinfo.binaryOps.urem, bytecode: 0x61},
    {optype: "i64", op: opinfo.binaryOps.and, bytecode: 0x62},
    {optype: "i64", op: opinfo.binaryOps.ior, bytecode: 0x63},
    {optype: "i64", op: opinfo.binaryOps.xor, bytecode: 0x64},
    {optype: "i64", op: opinfo.binaryOps.shl, bytecode: 0x65},
    {optype: "i64", op: opinfo.binaryOps.shr, bytecode: 0x66},
    {optype: "i64", op: opinfo.binaryOps.sar, bytecode: 0x67},
    {optype: "i64", op: opinfo.binaryOps.eq, bytecode: 0x68},
    {optype: "i64", op: opinfo.binaryOps.ne, bytecode: 0x69},
    {optype: "i64", op: opinfo.binaryOps.slt, bytecode: 0x6a},
    {optype: "i64", op: opinfo.binaryOps.sle, bytecode: 0x6b},
    {optype: "i64", op: opinfo.binaryOps.ult, bytecode: 0x6c},
    {optype: "i64", op: opinfo.binaryOps.ule, bytecode: 0x6d},
    {optype: "i64", op: opinfo.binaryOps.sgt, bytecode: 0x6e},
    {optype: "i64", op: opinfo.binaryOps.sge, bytecode: 0x6f},
    {optype: "i64", op: opinfo.binaryOps.ugt, bytecode: 0x70},
    {optype: "i64", op: opinfo.binaryOps.uge, bytecode: 0x71},

    {optype: "f32", op: opinfo.binaryOps.add, bytecode: 0x75},
    {optype: "f32", op: opinfo.binaryOps.sub, bytecode: 0x76},
    {optype: "f32", op: opinfo.binaryOps.mul, bytecode: 0x77},
    {optype: "f32", op: opinfo.binaryOps.div, bytecode: 0x78},
    {optype: "f32", op: opinfo.binaryOps.min, bytecode: 0x79},
    {optype: "f32", op: opinfo.binaryOps.max, bytecode: 0x7a},

    {optype: "f32", op: opinfo.binaryOps.eq, bytecode: 0x83},
    {optype: "f32", op: opinfo.binaryOps.ne, bytecode: 0x84},
    {optype: "f32", op: opinfo.binaryOps.lt, bytecode: 0x85},
    {optype: "f32", op: opinfo.binaryOps.le, bytecode: 0x86},
    {optype: "f32", op: opinfo.binaryOps.gt, bytecode: 0x87},
    {optype: "f32", op: opinfo.binaryOps.ge, bytecode: 0x88},

    {optype: "f64", op: opinfo.binaryOps.add, bytecode: 0x89},
    {optype: "f64", op: opinfo.binaryOps.sub, bytecode: 0x8a},
    {optype: "f64", op: opinfo.binaryOps.mul, bytecode: 0x8b},
    {optype: "f64", op: opinfo.binaryOps.div, bytecode: 0x8c},
    {optype: "f64", op: opinfo.binaryOps.min, bytecode: 0x8d},
    {optype: "f64", op: opinfo.binaryOps.max, bytecode: 0x8e},

    {optype: "f64", op: opinfo.binaryOps.eq, bytecode: 0x97},
    {optype: "f64", op: opinfo.binaryOps.ne, bytecode: 0x98},
    {optype: "f64", op: opinfo.binaryOps.lt, bytecode: 0x99},
    {optype: "f64", op: opinfo.binaryOps.le, bytecode: 0x9a},
    {optype: "f64", op: opinfo.binaryOps.gt, bytecode: 0x9b},
    {optype: "f64", op: opinfo.binaryOps.ge, bytecode: 0x9c},
  ];
